...
final TextStyle itemHintStyle =
    TextStyle(color: JuiColors().disabled, fontSize: 16, fontWeight: FontWeight.w400, height: 1.5);
...
final TextStyle itemContentStyle =
    TextStyle(color: JuiColors().text, fontSize: 16, fontWeight: FontWeight.w400, height: 1.5);
