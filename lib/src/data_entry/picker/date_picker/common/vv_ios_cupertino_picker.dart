...
// lens.
const double _kOverAndUnderCenterOpacity = 1.0;
...
class VViOSCupertinoPicker extends StatefulWidget {
  ...
  @override
  State<StatefulWidget> createState() => _VViOSCupertinoPickerState();
}

class _VViOSCupertinoPickerState extends State<VViOSCupertinoPicker> {
  ...
  @override
  void didUpdateWidget(VViOSCupertinoPicker oldWidget) {
